...
| [menus.md](menus.md) | toppmenyen, navigasjonsmodalen (områder + mapper), kontoknappen/-modalen, **objektmenyen** på alle seks nivåene og sveip-for-å-slette | **ja** — navigasjon og menyer |
