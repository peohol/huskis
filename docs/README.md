...
| [drag-and-drop.md](drag-and-drop.md) | reorder, flytting mellom lister/mapper/områder, ekstrahering, peek, auto-scroll, de to dra-scopene — og hvilken motor som driver hvilket scope mens migreringen pågår | **ja** — dra-og-slipp-motoren |
